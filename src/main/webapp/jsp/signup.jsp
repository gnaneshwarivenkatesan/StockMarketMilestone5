...
<div class="container-fuild">
     ...
     <form:form class="form-horizontal" method="POST" action="/register" modelAttribute="e2">
             ...
             <div class="Absolute-Center is-Responsive"> 
                ...
                <div class="form-group ">
                    ...
                    <div class="col-sm-4">
                        <form:input class="form-control" path="userName" type="text" id="user"/>
                        <div class="has-error">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-2" for="id2">Email Id</label>
                    <div class="col-sm-4">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <form:input class="form-control" path="mobileNumber" type="text" id="mobile"/>
                        <div class="has-error">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-2" for="id2">UserType</label>
                    <div class="col-sm-4">
                        <form:select class="form-control" path="userType" type="text" id="type">
                        <option>Admin</option>
                        <option>User</option>
                        </form:select>
                        <div class="has-error">
