...
<div class="container-fuild">
     ...
     <form:form class="form-horizontal" method="POST" action="/login" modelAttribute="login">
            ...
            <div class="Absolute-Center is-Responsive">
                ...
                <div class="form-group ">
                    ...
                    <div class="col-sm-4">
                        <form:input class="form-control" name="user" path="userName" type="text" />
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    Don't you have an account?<a href="/register">SignUp</a>
                </div>
            </div></form:form>
